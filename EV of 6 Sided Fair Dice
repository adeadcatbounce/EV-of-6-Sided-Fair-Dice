...
plt.title("Expected Value as A Function of Number of Rolls of A Six Sided Fair Dice", fontsize=14, fontweight="bold")
sns.barplot(x='EV', y='Trials', data=df, width=1/3)
plt.xlabel("Number of Rolls, of a Six Side Fair Dice", fontsize=12)
